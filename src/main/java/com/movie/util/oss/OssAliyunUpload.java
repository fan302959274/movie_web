 ...
 * 断点续传上传文件工具类
 */
public class OssAliyunUpload  implements Runnable{
     ...
     *            上传到OSS后的文件名
     */
    public OssAliyunUpload(MultipartFile localFile, long startPos, long partSize, int partNumber, String uploadId, String key , String bucketName) {
        this.localFile = localFile;
        this.startPos = startPos;
        this.partSize = partSize;
        this.partNumber = partNumber;
        this.uploadId = uploadId;
        OssAliyunUpload.key = key;
        OssAliyunUpload.bucketName = bucketName;
    }
    ...
    public void run() {
        ...
        try {
            ...
            UploadPartResult uploadPartResult = OssUploadByPartUtil.client.uploadPart(uploadPartRequest);
    ...
    protected static String claimUploadId(String bucketName, String key) {
        ...
        InitiateMultipartUploadResult result = OssUploadByPartUtil.client.initiateMultipartUpload(request);
    ...
    protected static void completeMultipartUpload(String uploadId) {
        ...
        // 完成分块上传
        OssUploadByPartUtil.client.completeMultipartUpload(completeMultipartUploadRequest);
    }
    ...
    protected static void listAllParts(String uploadId) {
        ...
        // 获取上传的所有分块信息
        PartListing partListing = OssUploadByPartUtil.client.listParts(listPartsRequest);
